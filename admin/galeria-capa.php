...
<html lang="pt-br">
        	...
        	<div class="container-fluid">
						<div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="header">
										<h4 class="title">Galeria - Imagens de Capa</h4>
										<p class="category">Imagens utilizadas como capa de um programa</p>
									</div>
									<div class="content">
										<!-- <div class="row"> -->
										<div id="imagem-galeria" class="picture" itemscope itemtype="http://schema.org/ImageGallery">
											<?php
												...
												foreach($imagens as $imagem){
													...
													echo '<div class="col-xs-6 col-sm-6 col-md-4 col-lg-2" style="margin-top: 8px; margin-bottom: 8px;height: 160px;"> ';
														echo '<div style="padding: 6px; border: 1px solid #ddd; border-radius: 4px; height: inherit;">';
															...
															echo '<p style=" font-size: 14px; margin-bottom: 0px;argin-left: 5px; max-width: inherit; white-space: nowrap; overflow: hidden;text-overflow: ellipsis;" data-tg="tooltip" data-placement="bottom" title="'.$nome_img[2].'">'.$nome_img[2].'</p>';
														echo '</div>';
												 	echo '</div>';
			...
			<div class="modal-dialog modal-sm" role="document">
				<div class="modal-content">
						...
						<div class="content">
							<div class="box" >
								<form id="image-uploader" enctype="multipart/form-data">
									<input type="file" name="files[]" id="multipleFiles" class="inputfile inputfile-4" data-multiple-caption="{count} files selected" multiple style="display:none;" accept="image/*"/>
					...
					<div class="modal-footer">
						...
						<button type="button" id="upload" class="btn btn-primary">Enviar</button>
					</div>
				</div>
			</div>
		</div>
  ...
  <!-- Light Bootstrap Dashboard Core javascript and methods -->
	...
	<script src="assets/js/galeria-capa.min.js"></script>
